...
app.post( '/report', async (req, res) => {
	try {
		// We changed this to https://snippets-web-challs.csc.tf on remote
		if ( !req.body.url || !req.body.url.match( /^http:\/\/127.0.0.1:3000\// ) ) {
		...
		// We changed this to snippets-web-challs.csc.tf on remote
		page.setCookie( { name: 'flag', value: process.env.FLAG, domain: '127.0.0.1' } );
